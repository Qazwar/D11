...
namespace ds {
	...
	void MeshBuffer::rotateY(float angle) {
		_rotation.y = angle;
	}

	void MeshBuffer::rotateX(float angle) {
		_rotation.x = angle;
	}

	void MeshBuffer::rotateZ(float angle) {
		_rotation.z = angle;
	}

	void MeshBuffer::translate(const v3& position) {
		_position = position;
	}

	void MeshBuffer::scale(const v3& scale) {
		_scale = scale;
	}
